...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('UrbanShoeApp', '0002_alter_sellerproductitem_unique_together_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='sellerorders',
            name='cart',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='UrbanShoeApp.cart'),
        ),
